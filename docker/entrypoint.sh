...
# Clean up stale Playwright MCP singleton files in persisted HOME cache.
rm -f /home/node/.cache/ms-playwright/mcp-chrome/SingletonLock \
      /home/node/.cache/ms-playwright/mcp-chrome/SingletonSocket \
      /home/node/.cache/ms-playwright/mcp-chrome/SingletonCookie 2>/dev/null || true
